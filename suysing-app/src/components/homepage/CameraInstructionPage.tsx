...
export default function CameraInstructionPage({ onClose }: CameraInstructionPageProps) {
  return (
      ...
      <div className="absolute bottom-32 ml-1 left-1/2 transform -translate-x-1/2 w-full max-w-xs">
        <div className="relative bg-white rounded-xl shadow-lg p-4 border-[3px] border-[#F78B1E]">
          <div className="flex items-center justify-center mb-4">
            <Image src="/images/camera.svg" alt="Camera" width={60} height={60} />
          </div>
          
          <p className="text-center mb-6">
         <span className="font-bold">Scan the QR codes </span>found in the booths and complete your Booth Hopping Card to redeem your Suki Day souvenir.
          </p>
