...
interface ApiCustomer {
  ...
  code: string;
  full_name: string;
  total_booth_visited: string;
  is_booth_hopping: string;
  is_booth_voting: string;
  is_souvenir_claim: string;
  customer_type: string;
  pretty_customer_type?: string;
...
interface BoothVoteHistory {
  booth_name: string;
  pretty_booth_color_code: string;
}
...
interface ApiBooth {
  ...
  rank_no?: number;
  pretty_color_code?: string;
  total_no_of_votes?: number;
}

interface ApiSouvenir {
  id: number;
  name: string;
  qty: number;
  claimed: number;
...
export const customerActivitiesData = {
  ...
  getSummary: async (token: string) => {
    try {
      const response = await httpClient(token).get(
        "/admin/customer-activities/dashboard-count/",
        {}
      );
...
export const boothActivitiesData = {
  ...
  updateBooth: async (token: string, post_data: UpdateBoothData) => {
    const { booth_id, booth_status } = post_data;

    try {
      const response = await httpClient(token).put(
        "/admin/booth-activities/update/",
        {
          booth_id: booth_id,
          status: booth_status,
        }
...
export const boothHoppingReportData = {
  ...
  getCustomerById: async (
    ...
    try {
      ...
      const total_pages =
        response_data?.booth_hopping_history?.total_pages || 0;
      const current_page =
...
export const bestBoothReportData = {
  ...
  getCustomersMock: async () => {
    return [
      ...
      },
      {
        ...
        totalVisited: 7,
        voteHistory: [{ color: "Blue Booth", name: "Blue Product Display" }],
      },
      {
        id: 4,
        code: "CUST004",
        ...
        totalVisited: 4,
        voteHistory: [{ color: "Red Booth", name: "Red Innovation Zone" }],
      },
      {
        id: 5,
        code: "CUST005",
  ...
  getCustomerById: async (id: number, token: string) => {
    try {
      const response = await httpClient(token).get(
        `/admin/best-booth/report/get-by-id/?customer_id=${id}`,
        {}
      );
...
export const souvenirClaimData = {
  ...
  updateCustomerStatus: async (
    token: string,
    post_data: UpdateCustomerStatusData
  ) => {
    const { customer_id, customer_status } = post_data;

    try {
      const response = await httpClient(token).put(
        "/admin/souvenir/update-customer-status/",
        {
...
export const bestBoothReportDataOriginal = {
  customers: [
    ...
    },
    {
      ...
      name: "Aldrin Tan",
      type: "Red",
      timeSubmitted: "May 4, 2025 | 1:35 PM",
    },
    {
      id: 3,
      code: "BRUN003",
      name: "Bruno Perez",
      type: "Red",
      timeSubmitted: "May 4, 2025 | 1:36 PM",
    },
    {
      id: 4,
      code: "OMAR004",
      name: "Omar Santiago",
      type: "Red",
      timeSubmitted: "May 4, 2025 | 1:52 PM",
    },
    {
      id: 5,
      code: "JOHN005",
      name: "John Dela Cruz",
      type: "Red",
      timeSubmitted: "May 4, 2025 | 2:30 PM",
    },
    {
      id: 6,
      code: "MATT006",
    ...
    },
    {
      ...
      name: "Robert Sebastian",
      type: "Green",
      timeSubmitted: "May 4, 2025 | 2:38 PM",
    },
    {
      id: 8,
      code: "ANDR008",
      name: "Andrew Philip",
      type: "Green",
      timeSubmitted: "May 4, 2025 | 2:45 PM",
    },
  ],
  getCustomers: async () => {
...
export const souvenirClaimDataOriginal = {
  claims: [
    ...
    },
    {
      ...
      status: "Claimed",
      item: "Massage Gun",
      timeClaimed: "May 4, 2025 | 2:30 PM",
    },
    {
      id: 6,
      code: "MATT006",
    ...
    },
    {
      ...
      status: "Claimed",
      item: "Massage Gun",
      timeClaimed: "May 4, 2025 | 2:38 PM",
    },
    {
      id: 8,
      code: "ANDR008",
      ...
      status: "Claimed",
      item: "Massage Gun",
      timeClaimed: "May 4, 2025 | 2:45 PM",
    },
  ],
  getClaims: async () => {
